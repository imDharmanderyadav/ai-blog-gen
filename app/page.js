...
export default function Home() {
  ...
  <div class="container px-5 py-24 mx-auto">
    ...
    <div class="flex lg:w-2/3 w-full flex-row  mx-auto px-8 sm:space-x-4 sm:space-y-0 space-y-4 sm:px-0 items-end">
      <div class="relative flex-grow w-full">
        <label htmlFor="full-name" class="leading-7 text-sm text-gray-600">write blog title to generate the blog </label>
